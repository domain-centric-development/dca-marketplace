...
│   ├── skills/{factory-backlog,factory-scope,factory-decisions,factory-status}/   # write the backlog; answer a scoping question; the decision inbox; where the pipeline stands
