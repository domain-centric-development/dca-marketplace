#!/usr/bin/env python3
"""Render the dca-init rule catalog reference from both rule libraries' catalogs.
...
def render(java: list[dict] | dict, dotnet: list[dict] | dict) -> str:
    ...
    lines = [
        ...
        "",
        "Every rule of the two rule libraries `/dca-init` wires into a project, grouped by rule set."
