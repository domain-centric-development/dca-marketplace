...
description: |
  ...
  especially in the domain and application layers of a layered or
  ports-and-adapters code base.
...
`AGENTS.md`), `AGENTS.md`, `CLAUDE.md`. Take from them:
