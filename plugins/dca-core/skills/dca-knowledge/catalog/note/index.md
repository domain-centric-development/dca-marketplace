...
- [The Store marker has no governing ArchUnit rules (governance gap)](store-marker-has-no-governing-rules.md) — The Store marker (`Store extends OutputPort`) is documented in the book
