...
- [Anti-Patterns](anti-patterns.md) — // ❌ BAD: Coupled to text and CSS
- [Best Practices](best-practices.md) — One user flow per test. If a test does multiple things, split it.
