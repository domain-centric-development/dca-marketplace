...
- [Event-Driven Architecture in Spring Modulith](event-driven-architecture-in-spring-modulith.md) — Spring Modulith supports two types of events that align with [Domain-Driven Design principles](./README.md#domain-eve...
- [Introduction](introduction.md) — Spring Modulith is a framework for building **modular monolithic applications** with Spring Boot. It implements the [...
