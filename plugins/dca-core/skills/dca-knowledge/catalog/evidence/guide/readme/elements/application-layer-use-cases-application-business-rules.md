---
type: Reference
title: "ELEMENTS — Application Layer (Use Cases / Application Business Rules)"
tags: [reference]
evidence_for: "/guide/readme/elements.md#application-layer-use-cases--application-business-rules"
---

[Full node and context](/guide/readme/elements.md#application-layer-use-cases--application-business-rules). This is an evidence excerpt; retain the parent selection and caveats.
