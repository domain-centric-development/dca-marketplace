---
type: Reference
title: "Use cases that save an aggregate or publish domain events must have a transaction boundary — `IntraClassCalls.entryPointsOf`"
tags: [reference]
evidence_for: "/rule/usecase/dca-use-012.md#intraclasscallsentrypointsof"
---

[Full node and context](/rule/usecase/dca-use-012.md#intraclasscallsentrypointsof). This is an evidence excerpt; retain the parent selection and caveats.
