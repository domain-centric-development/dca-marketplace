---
type: Reference
title: "Declaratively transactional use cases must not call remote-capable output ports — C# helper IntraClassCalls"
tags: [reference]
evidence_for: "/rule/usecase/dca-use-013.md#c-helper-intraclasscalls"
---

[Full node and context](/rule/usecase/dca-use-013.md#c-helper-intraclasscalls). This is an evidence excerpt; retain the parent selection and caveats.
