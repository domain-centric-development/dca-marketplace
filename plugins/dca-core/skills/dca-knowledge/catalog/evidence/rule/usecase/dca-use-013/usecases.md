---
type: Reference
title: "Declaratively transactional use cases must not call remote-capable output ports — `useCases`"
tags: [reference]
evidence_for: "/rule/usecase/dca-use-013.md#usecases"
---

[Full node and context](/rule/usecase/dca-use-013.md#usecases). This is an evidence excerpt; retain the parent selection and caveats.
