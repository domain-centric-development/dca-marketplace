---
type: Reference
title: "Use cases that save an aggregate must publish its domain events — `IntraClassCalls.closure`"
tags: [reference]
evidence_for: "/rule/usecase/dca-use-009.md#intraclasscallsclosure"
---

[Full node and context](/rule/usecase/dca-use-009.md#intraclasscallsclosure). This is an evidence excerpt; retain the parent selection and caveats.
