---
type: Reference
title: "Use cases that save an aggregate or publish domain events must have a transaction boundary — `useCases`"
tags: [reference]
evidence_for: "/rule/usecase/dca-use-012.md#usecases"
---

[Full node and context](/rule/usecase/dca-use-012.md#usecases). This is an evidence excerpt; retain the parent selection and caveats.
