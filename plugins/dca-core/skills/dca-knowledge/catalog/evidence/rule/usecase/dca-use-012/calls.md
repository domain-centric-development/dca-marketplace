---
type: Reference
title: "Use cases that save an aggregate or publish domain events must have a transaction boundary — `calls`"
tags: [reference]
evidence_for: "/rule/usecase/dca-use-012.md#calls"
---

[Full node and context](/rule/usecase/dca-use-012.md#calls). This is an evidence excerpt; retain the parent selection and caveats.
