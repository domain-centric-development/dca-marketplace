---
type: Reference
title: "Declaratively transactional use cases must not call remote-capable output ports — C# helper OperationPolicy"
tags: [reference]
evidence_for: "/rule/usecase/dca-use-013.md#c-helper-operationpolicy"
---

[Full node and context](/rule/usecase/dca-use-013.md#c-helper-operationpolicy). This is an evidence excerpt; retain the parent selection and caveats.
