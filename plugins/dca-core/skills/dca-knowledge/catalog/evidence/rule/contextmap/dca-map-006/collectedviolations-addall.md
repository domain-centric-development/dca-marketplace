---
type: Reference
title: "Upstream declarations and the module declaration's allowed dependencies must agree — `CollectedViolations.addAll`"
tags: [reference]
evidence_for: "/rule/contextmap/dca-map-006.md#collectedviolationsaddall"
---

[Full node and context](/rule/contextmap/dca-map-006.md#collectedviolationsaddall). This is an evidence excerpt; retain the parent selection and caveats.
