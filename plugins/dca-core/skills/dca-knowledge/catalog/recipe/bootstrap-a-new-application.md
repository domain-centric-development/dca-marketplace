...
- [The base InputPort interface must be in the sharedkernel marker port-in package](/rule/usecase/base-inputport-interface-must-be-in-the-building-blocks-port-in-package.md)
