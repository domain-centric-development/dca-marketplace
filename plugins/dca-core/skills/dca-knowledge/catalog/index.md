...
- [pitfall/](pitfall/index.md) (34) — Anti-patterns and the rules that forbid them.
...
- [rule/](rule/index.md) (121) — ArchUnit rules — the enforceable, machine-checkable architecture.
