...
- [decision/](decision/index.md) (18) — Decision guides for design forks (which pattern, when).
- [guide/](guide/index.md) (115) — The compact implementation guide — patterns, governance, supplementary guides (full text).
...
- [pitfall/](pitfall/index.md) (20) — Anti-patterns and the rules/ADRs that forbid them.
...
- [rule/](rule/index.md) (115) — ArchUnit rules — the enforceable, machine-checkable architecture.
