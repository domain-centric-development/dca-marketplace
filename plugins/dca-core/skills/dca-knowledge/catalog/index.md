...
- [decision/](decision/index.md) (21) — Decision guides for design forks (which pattern, when).
- [guide/](guide/index.md) (128) — The compact implementation guide — patterns, governance, supplementary guides (full text).
...
- [pitfall/](pitfall/index.md) (27) — Anti-patterns and the rules that forbid them.
