...
- [decision/](decision/index.md) (30) — Decision guides for design forks (which pattern, when).
- [evidence/](evidence/index.md) (125)
- [guide/](guide/index.md) (220) — The compact implementation guide — patterns, governance, supplementary guides (full text).
...
- [pitfall/](pitfall/index.md) (38) — Anti-patterns and the rules that forbid them.
- [process/](process/index.md) (1) — How-to processes for keeping the architecture's conventions.
- [recipe/](recipe/index.md) (22) — Task playbooks — ordered steps to build a DCA construct.
