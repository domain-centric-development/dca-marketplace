...
- [marker/](marker/index.md) (23) — Architectural marker interfaces — the contracts a new application implements.
...
- [rule/](rule/index.md) (94) — ArchUnit rules — the enforceable, machine-checkable architecture.
