...
- [marker/](marker/index.md) (28) — Architectural marker interfaces — the contracts a new application implements.
...
- [rule/](rule/index.md) (113) — ArchUnit rules — the enforceable, machine-checkable architecture.
