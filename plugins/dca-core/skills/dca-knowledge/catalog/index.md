...
- [decision/](decision/index.md) (29) — Decision guides for design forks (which pattern, when).
...
- [pitfall/](pitfall/index.md) (37) — Anti-patterns and the rules that forbid them.
- [process/](process/index.md) (1) — How-to processes for keeping the architecture's conventions.
- [recipe/](recipe/index.md) (21) — Task playbooks — ordered steps to build a DCA construct.
