...
- [decision/](decision/index.md) (25) — Decision guides for design forks (which pattern, when).
...
- [rule/](rule/index.md) (126) — ArchUnit rules — the enforceable, machine-checkable architecture.
