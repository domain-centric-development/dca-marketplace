...
- Related decisions: [Event delivery: sync, async, and when you need an outbox](/decision/event-delivery-sync-async-and-outbox.md) · [Domain event vs integration event](/decision/domain-event-vs-integration-event.md) · [Generated context map or strategic context map](/decision/generated-context-map-vs-strategic-map.md)
