...
- ADRs: [ADR-011 Bounded Context Isolation](/adr/adr-011-bounded-context-isolation.md)
...
- Book: [Service Decomposition](/book/deployment-patterns/service-decomposition.md) · [Migration Path](/book/deployment-patterns/migration-path.md)
