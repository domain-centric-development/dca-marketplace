...
evidence: [/marker/tactical/domainevent.md, /marker/port-out/domaineventpublisher.md, /marker/tactical/baseaggregateroot.md, /rule/usecase/dca-use-009.md, /guide/rules.md]
---
