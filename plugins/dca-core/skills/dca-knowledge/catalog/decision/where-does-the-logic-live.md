...
- Guide: [Default rule: pure domain services](/guide/domain-services-with-data-dependencies/default-regel-pure-domain-services-90-der-fälle.md) · [When to use which approach](/guide/domain-services-with-data-dependencies/vergleich-wann-welchen-ansatz-nutzen.md) · [Framework annotation rules](/guide/architecture-reference-guide/framework-annotations-rules.md) · [Layer elements](/guide/readme/elements.md)
