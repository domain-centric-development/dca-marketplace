---
type: Template
title: "Aggregate root skeleton (BaseAggregateRoot + Id + domain event) — Java"
parent: /template/aggregate-root.md
...
The Java code of [Aggregate root skeleton (BaseAggregateRoot + Id + domain event)](/template/aggregate-root.md). The prose, the evidence and what
