---
type: Template
title: "JPA repository adapter (same output port, Spring Data + entity + mapper) — Java"
parent: /template/jpa-repository-adapter.md
...
The Java code of [JPA repository adapter (same output port, Spring Data + entity + mapper)](/template/jpa-repository-adapter.md). The prose, the evidence and what
