...
- Guide: [Java package structure](/guide/package-structure.md) · [Context-specific rule sets](/guide/archunit-governance/context-specific-rule-sets.md) · [Spring Modulith core concepts](/guide/spring-modulith/core-concepts.md)
