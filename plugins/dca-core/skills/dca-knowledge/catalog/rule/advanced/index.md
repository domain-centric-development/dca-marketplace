...
- [Domain Events must have a timestamp field](domain-events-must-have-a-timestamp-field.md) — Domain Events must have a timestamp field.
...
- [Domain Events that are not Integration Events must not have a version field](domain-events-that-are-not-integration-events-must-not-have-a-version-field.md) — Domain Events that are not Integration Events must not have a version field.
